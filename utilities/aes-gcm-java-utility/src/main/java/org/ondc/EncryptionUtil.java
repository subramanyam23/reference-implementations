...
public class EncryptionUtil {
    ...
    public static String encryptData(String key, String data) {
        ...
        try {
            ...
            System.out.println("nonce:"+encryptedData.getNonce());
            System.out.println("eData: "+ encryptedData.getEncrypedData());
            System.out.println("authTag: "+encryptedData.getHmac());
...
//        System.out.println("nonce: " + encryptedData.getNonce());
//        System.out.println("encrypted text: " + encryptedData.getEncrypedData());
//        System.out.println("authTag: " + encryptedData.getHmac());
